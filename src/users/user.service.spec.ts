...
describe('UserService', () => {
  ...
  describe('verifyEmail', () => {
    it('should verify email', async () => {
      const modckedVerification = {
        user: {
          verified: false,
        },
        id : 1,
      };
      verificationsRepository.findOne.mockResolvedValue(modckedVerification);
      ...
      expect(verificationsRepository.delete).toHaveBeenCalledWith(modckedVerification.id);
